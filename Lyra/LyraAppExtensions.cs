...
namespace Lyra
{
    ...
    {
        public static void Route(this LyraApp app, string method, string path, Func<LyraContext, Task<ILyraResult>> handler) 
        ...
        public static void Route<T>(this LyraApp app, string method, string path, Func<LyraContext, T, Task<ILyraResult>> handler)
        ...
        public static void Get(this LyraApp app, string path, Func<LyraContext, Task<ILyraResult>> handler)
            => app.Route(HttpMethodConstant.Get, path, handler);
        public static void Get(this LyraApp app, string method, string path, Func<ILyraRequest, Task<ILyraResult>> handler)
            => app.Route(HttpMethodConstant.Get, path, handler);
        public static void Get<T>(this LyraApp app, string path, Func<LyraContext, T, Task<ILyraResult>> handler)
            => app.Route(HttpMethodConstant.Get, path, handler);
        ...
        public static void Post(this LyraApp app, string path, Func<LyraContext, Task<ILyraResult>> handler)
            => app.Route(HttpMethodConstant.Post, path, handler);
        public static void Post(this LyraApp app, string method, string path, Func<ILyraRequest, Task<ILyraResult>> handler)
            => app.Route(HttpMethodConstant.Post, path, handler);
        public static void Post<T>(this LyraApp app, string path, Func<LyraContext, T, Task<ILyraResult>> handler)
            => app.Route(HttpMethodConstant.Post, path, handler);


        public static void Put(this LyraApp app, string path, RequestHandler handler)
            => app.Route(HttpMethodConstant.Put, path, handler);
        public static void Put(this LyraApp app, string path, Func<LyraContext, Task<ILyraResult>> handler)
            => app.Route(HttpMethodConstant.Put, path, handler);
        public static void Put(this LyraApp app, string method, string path, Func<ILyraRequest, Task<ILyraResult>> handler)
            => app.Route(HttpMethodConstant.Put, path, handler);
        public static void Put<T>(this LyraApp app, string path, Func<LyraContext, T, Task<ILyraResult>> handler)
            => app.Route(HttpMethodConstant.Put, path, handler);
        ...
        public static void Delete(this LyraApp app, string path, Func<LyraContext, Task<ILyraResult>> handler)
            => app.Route(HttpMethodConstant.Delete, path, handler);
        public static void Delete(this LyraApp app, string method, string path, Func<ILyraRequest, Task<ILyraResult>> handler)
            => app.Route(HttpMethodConstant.Delete, path, handler);
        public static void Delete<T>(this LyraApp app, string path, Func<LyraContext, T, Task<ILyraResult>> handler)
            => app.Route(HttpMethodConstant.Delete, path, handler);
    }
}
